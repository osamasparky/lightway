...
/**
 * @param  $page => Setting::$pagesSeoMetas
...
/**
 * @param  $page => admin_login, admin_dashboard, login, register, remember_pass, search, categories,
...
function checkCourseForSale($course, $user)
{
    ...
    if ($course->checkUserHasBought($user) && !$course->canSale()) {
        $toastData = [
