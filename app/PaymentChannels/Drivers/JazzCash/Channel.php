...
class Channel extends BasePaymentChannel implements IChannel
{
    ...
    public function paymentRequest(Order $order)
    {
        ...
        try {
            ...
            Log::error('Payment gateway error [JazzCash]', ['error' => is_object($exception) && method_exists($exception, 'getMessage') ? $exception->getMessage() : $exception]); throw new \Exception('Payment processing failed');
