...
class Channel extends BasePaymentChannel implements IChannel
{
    ...
    public function paymentRequest(Order $order)
    {
        ...
        try {
            ...
            Log::error('Payment gateway error [Telebirr]', ['error' => is_object($exception) && method_exists($exception, 'getMessage') ? $exception->getMessage() : $exception]); throw new \Exception('Payment processing failed');
        }
    ...
    public function verify(Request $request)
    {
        ...
        Log::error('Payment gateway error [Telebirr]', ['error' => is_object($verification) && method_exists($verification, 'getMessage') ? $verification->getMessage() : $verification]); throw new \Exception('Payment processing failed');
