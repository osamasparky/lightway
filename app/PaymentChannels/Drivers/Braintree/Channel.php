...
//            Log::error('Payment gateway error [Braintree]', ['error' => is_object($exception) && method_exists($exception, 'getMessage') ? $exception->getMessage() : $exception]); throw new \Exception('Payment processing failed');
