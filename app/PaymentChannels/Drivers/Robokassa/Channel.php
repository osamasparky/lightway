...
class Channel extends BasePaymentChannel implements IChannel
{
    ...
    public function paymentRequest(Order $order)
    {
        ...
        /*} catch (\Exception $exception) {
            Log::error('Payment gateway error [Robokassa]', ['error' => is_object($exception) && method_exists($exception, 'getMessage') ? $exception->getMessage() : $exception]); throw new \Exception('Payment processing failed');
        }*/
