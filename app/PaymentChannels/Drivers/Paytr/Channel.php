...
Log::error('Payment gateway error [Paytr]', ['error' => is_object($verification) && method_exists($verification, 'getMessage') ? $verification->getMessage() : $verification]); throw new \Exception('Payment processing failed');
