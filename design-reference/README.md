# الرئيسية — تصميم جديد المخطوطة المزخرفة — design reference
...
- `HomeMS.dc.html` — the artboard (a Design Component: an `<x-dc>`
...
Serve the folder (e.g. `python3 -m http.server`) and open `HomeMS.dc.html`;
