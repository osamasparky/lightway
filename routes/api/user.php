...
Route::group(['middleware' => 'api.auth'], function () {
    ...
    Route::group(['prefix' => 'progress'], function () {
        Route::get('/gifted-items', ['uses' => 'UserAccessController@giftedItems']);
        Route::get('/courses-progress', ['uses' => 'UserAccessController@coursesProgress']);
    });
    ...
    Route::group(['prefix' => 'profile-setting'], function () {
        ...
        Route::post('/delete-account', 'UsersController@destroy');
    });
