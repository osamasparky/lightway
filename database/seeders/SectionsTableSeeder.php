...
class SectionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Translation Manager 3132 - 3133
        Section::updateOrCreate(['id' => 3132],['name' => 'admin_translation_manager','caption' => 'Translation Manager','type' => 'admin', ]);
        Section::updateOrCreate(['id' => 3133],['name' => 'admin_translation_manager_access','section_group_id' => 3132,'caption' => 'Access Translation Manager','type' => 'admin',]);
