...
<body>
    <div class="certificate-template-container">
        <img class="certificate-bg-image" src="' . $bgBase64 . '" width="930" height="600" />
...
Storage::disk('public')->put('test_mpdf_bg.pdf', $pdfContent);
echo "SUCCESS: Rendered with background image! File size: " . strlen($pdfContent) . " bytes\n";
