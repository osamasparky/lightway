...
@if(request()->path() != '/')
    @include('web.default.includes.lightway.course_card', ['webinar' => $webinar, 'variant' => 'list', 'isRewardCourses' => $isRewardCourses ?? null])
@else
<div class="webinar-card webinar-list webinar-list-2 d-flex mt-30">
    <div class="image-box">
        ...
        <a href="{{ $webinar->getUrl() }}">
            <img loading="lazy" src="{{ $webinar->getImage() }}" class="img-cover" alt="{{ $webinar->title }}">
        </a>
    ...
    <div class="webinar-card-body w-100 d-flex flex-column">
        ...
        <div class="user-inline-avatar d-flex align-items-center mt-10">
            <div class="avatar bg-gray200">
                <img loading="lazy" src="{{ $webinar->teacher->getAvatar() }}" class="img-cover" alt="{{ $webinar->teacher->full_name }}">
            </div>
