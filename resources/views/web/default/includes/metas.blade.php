...
<meta property='og:site_name' content='{{ !empty($generalSettings['site_name']) ? $generalSettings['site_name'] : config('app.name') }}'>
<meta property='og:image' content='{{ url($pageMetaImage) }}'>
<meta name='twitter:image' content='{{ url($pageMetaImage) }}'>
<meta property='og:locale' content='{{ !empty($generalSettings['locale']) ? $generalSettings['locale'] : (app()->getLocale() == 'ar' ? 'ar_SA' : 'en_US') }}'>
