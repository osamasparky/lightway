    ...
    <div class="text-center">
        ...
        <div class="mt-32 mt-lg-40 row align-items-center font-14">
            <a href="{{ $product->getShareLink('telegram') }}" target="_blank" class="col text-center">
                <img loading="lazy" src="/assets/default/img/social/telegram.svg" width="50" height="50" alt="telegram">
            ...
            <a href="{{ $product->getShareLink('whatsapp') }}" target="_blank" class="col text-center">
                <img loading="lazy" src="/assets/default/img/social/whatsapp.svg" width="50" height="50" alt="whatsapp">
            ...
            <a href="{{ $product->getShareLink('facebook') }}" target="_blank" class="col text-center">
                <img loading="lazy" src="/assets/default/img/social/facebook.svg" width="50" height="50" alt="facebook">
            ...
            <a href="{{ $product->getShareLink('twitter') }}" target="_blank" class="col text-center">
                <img loading="lazy" src="/assets/default/img/social/twitter.svg" width="50" height="50" alt="twitter">
