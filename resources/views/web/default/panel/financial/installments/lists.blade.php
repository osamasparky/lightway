            ...
            <div class="row">
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img loading="lazy" src="/assets/default/img/activity/129.png" width="64" height="64" alt="">
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img loading="lazy" src="/assets/default/img/activity/130.png" width="64" height="64" alt="">
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img loading="lazy" src="/assets/default/img/activity/127.png" width="64" height="64" alt="">
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img loading="lazy" src="/assets/default/img/activity/128.png" width="64" height="64" alt="">
                                ...
                                <a href="{{ (in_array($itemType, ['course', 'bundle', 'product'])) ? $orderItem->getUrl() : '#!' }}" target="_blank" class="">
                                    <div class="image-box">
                                        @if(in_array($itemType, ['course', 'bundle']))
                                            <img loading="lazy" src="{{ $orderItem->getImage() }}" class="img-cover" alt="">
                                        @elseif($itemType == 'product')
                                            <img loading="lazy" src="{{ $orderItem->thumbnail }}" class="img-cover" alt="">
                                        @elseif($itemType == "subscribe")
                                            <div class="d-flex align-items-center justify-content-center w-100 h-100">
                                                <img loading="lazy" src="/assets/default/img/icons/installment/subscribe_default.svg" alt="">
                                            </div>
                                        @elseif($itemType == "registrationPackage")
                                            <div class="d-flex align-items-center justify-content-center w-100 h-100">
                                                <img loading="lazy" src="/assets/default/img/icons/installment/reg_package_default.svg" alt="">
                                            </div>
                                        @endif
