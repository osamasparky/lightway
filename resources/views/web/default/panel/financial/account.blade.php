    ...
    @if(!empty($registrationBonusAmount))
        <div class="mb-25 d-flex align-items-center justify-content-between p-15 bg-white panel-shadow">
            <div class="d-flex align-items-center">
                <img loading="lazy" src="/assets/default/img/icons/money.png" alt="money" width="51" height="51">
    ...
    <section>
        ...
        <div class="activities-container mt-25 p-20 p-lg-35">
            <div class="row">
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img loading="lazy" src="/assets/default/img/activity/37.svg" width="64" height="64" alt="">
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img loading="lazy" src="/assets/default/img/activity/38.svg" width="64" height="64" alt="">
            ...
            @foreach($offlineBanks as $offlineBank)
                <div class="col-12 col-lg-3 mb-30 mb-lg-0">
                    <div class="py-25 px-20 rounded-sm panel-shadow d-flex flex-column align-items-center justify-content-center">
                        <img loading="lazy" src="{{ $offlineBank->logo }}" width="120" height="60" alt="">
