            ...
            <div class="row">
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img loading="lazy" src="/assets/default/img/activity/physical_product3.png" width="64" height="64" alt="">
                ...
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img loading="lazy" src="/assets/default/img/activity/physical_product2.png" width="64" height="64" alt="">
                ...
                <div class="col-6 col-md-3 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img loading="lazy" src="/assets/default/img/activity/physical_product1.png" width="64" height="64" alt="">
                                        ...
                                        <td class="text-left">
                                            <div class="user-inline-avatar d-flex align-items-center">
                                                <div class="avatar bg-gray200">
                                                    <img loading="lazy" src="{{ !empty($order->seller) ? $order->seller->getAvatar() : '' }}" class="img-cover" alt="">
                                                </div>
                                                <div class=" ml-5">
                                                ...
                                                <div class="btn-group dropdown table-actions">
                                                    ...
                                                    <div class="dropdown-menu font-weight-normal">
                                                        ...
                                                        @if(!empty($order->product) and $order->product->isVirtual() and !empty($order->product->files) and count($order->product->files))
                                                            <a href="/panel/store/products/{{ $order->product->id }}/getFilesModal" class="js-show-product-files webinar-actions d-block mt-10">{{ trans('home.download') }}</a>
                                                        @endif
