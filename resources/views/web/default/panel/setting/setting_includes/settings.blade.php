        ...
        <div class="row mt-30">
            ...
            <div class="col-12 col-lg-8">
                <div class="form-group">
                    ...
                    <input type="hidden" id="LocationLatitude" name="latitude" value="{{ (!empty($user->location)) ? $user->location[0] : getDefaultMapsLocation()['lat'] }}">
                    <input type="hidden" id="LocationLongitude" name="longitude" value="{{ (!empty($user->location)) ? $user->location[1] : getDefaultMapsLocation()['lon'] }}">
                    ...
                    <div id="mapContainer" class="d-none">
                        ...
                        <div class="region-map mt-10" id="mapBox"
                             data-zoom="12"
                        >
                            <img loading="lazy" src="/assets/default/img/location.png" class="marker">
                        </div>
                    </div>
                </div>
            </div>
