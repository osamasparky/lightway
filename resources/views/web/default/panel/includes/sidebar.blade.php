...
<div class="xs-panel-nav d-flex d-lg-none justify-content-between py-5 px-15">
    <div class="user-info d-flex align-items-center justify-content-between">
        <div class="user-avatar bg-gray200">
            <img loading="lazy" src="{{ $authUser->getAvatar(100) }}" class="img-cover" alt="{{ $authUser->full_name }}">
        </div>
...
<div class="panel-sidebar pt-50 pb-25 px-25" id="panelSidebar">
    ...
    <ul id="panel-sidebar-scroll" class="sidebar-menu pt-10 @if(!empty($authUser->userGroup)) has-user-group @endif @if(empty($getPanelSidebarSettings) or empty($getPanelSidebarSettings['background'])) without-bottom-image @endif" @if((!empty($isRtl) and $isRtl)) data-simplebar-direction="rtl" @endif>
        ...
        @if($authUser->isUser())
            ...
            <li class="sidenav-item {{ (request()->is('panel/progress') or request()->is('panel/progress/*')) ? 'sidenav-item-active' : '' }}">

                <a class="d-flex align-items-center"
                  data-toggle="collapse"
                  href="#progressCollapse"
                  role="button"
                  aria-expanded="false"
                ...
                <div class="collapse {{ (request()->is('panel/progress') or request()->is('panel/progress/*')) ? 'show' : '' }}"
                    id="progressCollapse">

                    <ul class="sidenav-item-collapse">

                        <li class="mt-5 {{ request()->is('panel/progress/gifted-items') ? 'active' : '' }}">
                            <a href="/panel/progress/gifted-items">
                                Gifted Items
                            </a>
                        </li>

                        <li class="mt-5 {{ request()->is('panel/progress/courses-progress') ? 'active' : '' }}">
                            <a href="/panel/progress/courses-progress">
                                Courses Progress
                            </a>
                        </li>
